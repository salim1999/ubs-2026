...
- **Acceptance check:** vcv hgb_tuned ≈ 0.48, vcv ens ≈ 0.475, valid ens ≈ 0.476 (±0.01 for library versions), valid `c_detect` ≈ 0.67. If you land far off, stop and diff your code against combo A before going further.
...
### Phase 4: ship a submission (before any optional experiment)
